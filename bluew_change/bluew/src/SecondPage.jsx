    ...
    return ( 
        <div className="secondpage bg-gray-200 relative h-fit pb-8">
            ...
            <div className="learn-header ml-7 top-10 relative">
                ...
                <div className="learn-underline w-[28%] md:w-[45%] sm:w-[80%] lg:w-[38%] h-3 bg-[#33918C]">

                </div>
            </div>
            <div className="cards flex gap-14 md:gap-8 sm:flex-col sm:gap-6 hover:cursor-pointer md:overflow-x-auto lg:overflow-x-auto ">
                {smallAboutDetails.map((item) => (
                    <div className="card flex flex-col mt-20 ml-20 lg:ml-8 sm:ml-8 2xl:hover:shadow-cardBoxShadow xl:hover:shadow-cardBoxShadow lg:hover:shadow-cardBoxShadow transition-all duration-300 h-fit" key={item.id}>
